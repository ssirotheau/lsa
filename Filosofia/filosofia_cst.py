...
for i in range(0,len(documents)):
    documents_cst.append(cleanData(documents[i], lowercase = True,remove_stops = True,stemming = True))

#print(documents_cst[1]);exit(1)

documents=documents_cst
